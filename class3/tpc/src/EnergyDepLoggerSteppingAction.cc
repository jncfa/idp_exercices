...
#include "EnergyDepLoggerSteppingAction.hh"
...
EnergyDepLoggerSteppingAction::SteppingAction()
{
...
void EnergyDepLoggerSteppingAction::UserSteppingAction(const G4Step* thisStep)
{ 
